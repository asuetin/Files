...
namespace Files.Commands
{
    public partial class ItemOperations
    {
        public static async void DeleteItemWithStatus(StorageDeleteOption deleteOption)
        {
            ...
            var res = await DeleteItem(deleteOption, CurrentInstance, bannerResult.Progress);
            bannerResult.Remove();
            sw.Stop();
            if (!res)
            {
        ...
        private static async Task<FilesystemResult> DeleteItem(StorageDeleteOption deleteOption, IShellPage AppInstance, IProgress<uint> progress)
        {
